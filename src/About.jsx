      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 h-auto md:h-[800px]">
          ...
          >
            ...
            <div className="max-h-[40vh] lg:max-h-none overflow-y-auto pr-2 flex flex-col gap-4 md:gap-6">
              {profile.intro.map((paragraph, index) => (
                <p key={index} className="text-sm md:text-lg text-muted leading-relaxed">
                  {paragraph}
                </p>
              ))}
            </div>
            <div className="p-4 bg-background/50 rounded-xl border-l-4 border-accent mt-4">
              <p className="text-text italic">"{profile.quote}"</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="max-h-[30vh] lg:max-h-none overflow-y-auto pr-2">
